...
public class BodyActivity extends AppCompatActivity {
    ...
    public static final int DEFAULT_CAT_ID = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_whats_new, R.id.nav_women,
                R.id.nav_men, R.id.nav_gears, R.id.nav_training,
                R.id.nav_sale, R.id.nav_share, R.id.nav_send)
